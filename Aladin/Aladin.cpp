...
void CAladin::LoadResources(int ID)
{
	...
	// --------chém phải--------
	sprites->AddEx(10200, 5, 337, 5 + 45, 51 + 337, 36, 51, texAladin);
	sprites->AddEx(10201, 54, 326, 54 + 51, 326 + 62, 41, 62, texAladin);
	sprites->AddEx(10202, 115, 314, 115 + 45, 314 + 74, 41, 74, texAladin);
	sprites->AddEx(10203, 171, 324, 171 + 82, 324 + 64, 82, 64, texAladin);
	sprites->AddEx(10204, 260, 335, 260 + 51, 53 + 335, 44, 53, texAladin);
