...
void CBrick::LoadResources(int ID)
{
	...
	if (this->id == eType::BRICK)
	{
		...
		this->AddAnimation(601); //animation brick
	}
	else if (this->id == eType::BRICK_BALL)
	{
		// BRICK VER 2
		...
		this->AddAnimation(602); //ball
	}
	else if (this->id == eType::BRICK_LINE)
	{
